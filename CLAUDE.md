...
**Pitch · growth model · go-to-market** (category line, land-and-expand ladder, Luckin playbook + CFO
discipline) live in **`docs/positioning.md`** — read it for any bizdev/pitch work (or run `/my-bizdev`).
Kept out of this file to keep per-turn operating guidance lean.
