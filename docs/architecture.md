...
(**140 endpoints, 45 tables**). State lives in PostgreSQL via SQLAlchemy 2.0; Alembic
manages schema (32 migrations). The Next.js frontend (App Router, **31 routes**) serves
