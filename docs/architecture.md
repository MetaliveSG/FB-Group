...
(**136 endpoints, 43 tables**). State lives in PostgreSQL via SQLAlchemy 2.0; Alembic
manages schema (26 migrations). The Next.js frontend (App Router, **30 routes**) serves
