...
(**148 endpoints, 46 tables**). State lives in PostgreSQL via SQLAlchemy 2.0; Alembic
manages schema (36 migrations). The Next.js frontend (App Router, **33 routes**) serves
