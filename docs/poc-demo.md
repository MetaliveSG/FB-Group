...
- **Automated tests:** **287 backend (pytest) + 58 frontend (Vitest), all green** — `artifacts/pytest_results.txt`, `artifacts/frontend_test_results.txt`.
...
- FastAPI + SQLAlchemy 2.0 + **PostgreSQL** (43 tables, 24 migrations, 137 endpoints), Next.js 14, fully Dockerised, AWS-target (ECS Fargate + RDS).
