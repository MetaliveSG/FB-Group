...
- **Automated tests:** **191 backend (pytest) + 45 frontend (Vitest), all green** — `artifacts/pytest_results.txt`, `artifacts/frontend_test_results.txt`.
...
- FastAPI + SQLAlchemy 2.0 + **PostgreSQL** (41 tables, 13 migrations, 107 endpoints), Next.js 14, fully Dockerised, AWS-target (ECS Fargate + RDS).
