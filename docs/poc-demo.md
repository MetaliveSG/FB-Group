...
- **Automated tests:** **104 backend (pytest) + 37 frontend (Vitest), all green** — `artifacts/pytest_results.txt`, `artifacts/frontend_test_results.txt`.
...
- FastAPI + SQLAlchemy 2.0 + **PostgreSQL** (40 tables, 7 migrations, 92 endpoints), Next.js 14, fully Dockerised, AWS-target (ECS Fargate + RDS).
