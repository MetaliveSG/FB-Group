...
- **Automated tests:** **129 backend (pytest) + 45 frontend (Vitest), all green** — `artifacts/pytest_results.txt`, `artifacts/frontend_test_results.txt`.
...
- FastAPI + SQLAlchemy 2.0 + **PostgreSQL** (40 tables, 9 migrations, 93 endpoints), Next.js 14, fully Dockerised, AWS-target (ECS Fargate + RDS).
