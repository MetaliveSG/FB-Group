...
## 2. What was built
- **Backend** (`apps/api`): FastAPI + SQLAlchemy 2.0, **41 tables**, **98 API endpoints**, 13 Alembic migrations.
...
## 8. API documentation
Swagger `/docs`, ReDoc `/redoc`, machine spec `artifacts/openapi.json` (98 endpoints),
...
Postgres stack. **The app runs; 170 backend + 45 frontend tests pass; the QR→order→
