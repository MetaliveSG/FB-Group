...
## 2. What was built
- **Backend** (`apps/api`): FastAPI + SQLAlchemy 2.0, **41 tables**, **93 API endpoints**, 13 Alembic migrations.
...
Postgres stack. **The app runs; 152 backend + 45 frontend tests pass; the QR→order→
