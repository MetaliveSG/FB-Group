...
## 2. What was built
- **Backend** (`apps/api`): FastAPI + SQLAlchemy 2.0, **41 tables**, **109 API endpoints**, 13 Alembic migrations.
...
## 8. API documentation
Swagger `/docs`, ReDoc `/redoc`, machine spec `artifacts/openapi.json` (109 endpoints),
...
Postgres stack. **The app runs; 194 backend + 45 frontend tests pass; the QR→order→
